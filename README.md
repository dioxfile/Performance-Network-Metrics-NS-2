...
### OBS: However, if you want to use the packet sizes as generated in the trace, that's fine. In this context, the throughput will be a little higher, but for all nodes, without affecting the final result.
